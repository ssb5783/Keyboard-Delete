...
public class SSB_FrontJumpTrapFloor : MonoBehaviour
{
    //리지드바디
    Rigidbody rb;
    //스피드
    ...
    private void OnCollisionEnter(Collision collision)
    {
        ...
        collision.gameObject.GetComponent<Rigidbody>().velocity = -(Vector3.forward + Vector3.right )+Vector3.up * JumpPower;  
        isUp = true;
